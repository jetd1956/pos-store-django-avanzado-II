...
var sale = {
    detail: {
        subtotal_sin_iva: 0.00,
        subtotal_con_iva: 0.00,
        subtotal: 0.00,
        dscto: 0.00,
        total_dscto: 0.00,
        iva: 0.00,
    ...
    calculateInvoice: function () {
        ...
        this.detail.subtotal_sin_iva = this.detail.products.filter(value => !value.with_tax).reduce((a, b) => a + (b.total || 0), 0);
        this.detail.subtotal_con_iva = this.detail.products.filter(value => value.with_tax).reduce((a, b) => a + (b.total || 0), 0);
        this.detail.subtotal = parseFloat(this.detail.subtotal_sin_iva) + parseFloat(this.detail.subtotal_con_iva);
        ...
        $('input[name="subtotal_sin_iva"]').val(this.detail.subtotal_sin_iva.toFixed(2));
        $('input[name="subtotal_con_iva"]').val(this.detail.subtotal_con_iva.toFixed(2));
