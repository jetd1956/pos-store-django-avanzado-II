...
env = environ.Env(
    # podemos cargar valores por defecto aca pero por ahora no lo hacemos
...
DATABASES = {
            # db() es una variable de la libreria django-environ que me arma la coneccion
            # a la base de datos a partir de la variable DATABASE_URL
    #'default': env.db()
